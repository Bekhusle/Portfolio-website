...
<header id="header">
  <div class="container">
    ...
    <h5 id="hello-text" style="color: rgb(255 53 174);font-weight:bold;font-size:23px;text-shadow: 2px 0px 0px #ffffff;">Сайн уу<span class="wave">👋</span>, Би бол </h5>
    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        <?php if ($user_data['home_section']) { ?>
          <li><a class="nav-link active" href="#header" data-section="home">Нүүр</a></li>
        <?php } ?>

        <?php if ($user_data['about_section']) { ?>
          <li><a class="nav-link" href="#about" data-section="about">Миний</a></li>
        <?php } ?>

        <?php if ($user_data['resume_section']) { ?>
          <li><a class="nav-link" href="#resume" data-section="resume">Дэлгэрэнгүй</a></li>
        <?php } ?>

        <?php if ($user_data['services_section']) { ?>
          <li><a class="nav-link" href="#services" data-section="services"></a></li>
        <?php } ?>

        <?php if ($user_data['portfolio_section']) { ?>
          <li><a class="nav-link" href="#portfolio" data-section="portfolio">Миний бүтээл</a></li>
        <?php } ?>

        <?php if ($user_data['contact_section']) { ?>
          <li><a class="nav-link" href="#contact" data-section="contact">Холбоо барих</a></li>
        <?php } ?>
      </ul>
...
<div id="download-container">
  <a href="./battsengel huselzaya.jpg" download class="download-button"> CV татаж авах</a>
</div>
