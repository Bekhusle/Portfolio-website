...
<body>
  ...
  <section id="about" class="about">
    ...
    <div class="about-me container">
      ...
      <div class="section-title">
        <h2>Миний тухай</h2>
        <p>Миний тухай илүү ихийг мэдэж аваарай</p>
      </div>
  ...
  <section id="resume" class="resume">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6">
          <h3 class="resume-title">Ажлын туршлага</h3>
        ...
        <div class="col-lg-6">
          <h3 class="resume-title">Арван жил</h3>
          <?php
...
<div class="container contact-container">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" role="form" class="contact-form">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <input type="text" name="name" class="form-control" id="name" placeholder="Нэр" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="subject" id="subject" placeholder="Агуулга" required>
        </div>
        <div class="form-group">
            <textarea class="form-control" name="message" rows="5" placeholder="Зурвас" required></textarea>
        </div>
        <div class="text-center"><button type="submit" name="send_message" class="btn btn-success">Илгээх</button></div>
    </form>
</div>
